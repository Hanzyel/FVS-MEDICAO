# Elevatta Medição + FVS — Android/PWA 1.7.8
...
- Build Command: `echo "Elevatta FVS PWA Android 1.7.8"`
- Publish Directory: `.`
...
## Persistência ao recarregar (1.7.8)
...
## Novidade 1.7.8 — rastreabilidade da execução
...
## Novidade 1.7.8 — Criar outro relatório
